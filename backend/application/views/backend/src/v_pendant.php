...
<head>
    ...
    <title>Pendants Banner - Backend</title>
                ...
                <div id="change" class="tabcontent">
                    ...
                    <?php echo form_open_multipart('c_pendant/gf_transact');?>                    
                        ...
                        <div class="form-group col-md-6">
                             ...
                             <input allow-empty="false" type="text" placeholder="Id Pendant" name="PendantId" id="PendantId" class="form-control" maxlength="50" value="Auto" readonly required>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input allow-empty="false" type="text" placeholder="Pendant Name" name="PendantName" id="PendantName" class="form-control" maxlength="50" value="" required>
                        </div>

                         <div class="form-group col-md-6">
                            <label>Pendant Description</label>
                            <textarea id="PendantDesc" name="PendantDescription" rows="10" cols="30" class="form-control" placeholder="Banner Description" required></textarea>
                        </div>
...
<script>
  ...
  function delete_data(){
      id=$("#target").val();
      $.post("<?php echo base_url('index.php/c_pendant/gf_delete'); ?>",
      {
        id_data:id
      },
