            ...
            <div class="container-fluid p-5">
                ...
                <?php echo form_open_multipart('c_earrings/gf_transact');?>
                    ...
                    <div class="form-group col-md-6">
                         <label>Earring Id</label>
                         <input allow-empty="false" type="text" placeholder="Id Earrings" name="EarringsId" id="EarringsId" class="form-control" maxlength="50" value="Auto" readonly>
                    </div>
