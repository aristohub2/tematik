...
<head>
    ...
    <title>Earrings Banner - Backend</title>
        ...
        <main class="page-content pt-2">
            ...
            <div class="container-fluid p-5">
                ...
                <div id="change" class="tabcontent">
                    ...
                    <?php echo form_open_multipart('c_earrings/gf_transact');?>                    

                        <div class="form-group col-md-6">
                         <label>Earrings Id</label>
                         <input allow-empty="false" type="text" placeholder="Id Earrings" name="EarringsId" id="EarringsId" class="form-control" maxlength="50" value="Auto" readonly required>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            <label>Earrings Name</label>
                            <input allow-empty="false" type="text" placeholder="Earrings Title" name="EarringsName" id="EarringsName" class="form-control" maxlength="50" value="" required>
                        </div>

                         <div class="form-group col-md-6">
                            <label>Earrings Description</label>
                            <textarea id="EarringsDescription" name="EarringsDescription" rows="10" cols="30" class="form-control" placeholder="Banner Description" required></textarea>
                        </div>
...
<script>
  ...
  function delete_data(){
      id=$("#target").val();
      $.post("<?php echo base_url('index.php/c_earrings/gf_delete'); ?>",
      {
        id_data:id
      },
