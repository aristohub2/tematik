                ...
                <div id="change" class="tabcontent">
                    ...
                    <?php echo form_open_multipart('c_necklaces/gf_transact');?>                    
                        ...
                        <div class="form-group col-md-6">
                         ...
                         <input allow-empty="false" type="text" placeholder="Id Necklaces" name="NecklacesId" id="NecklacesId" class="form-control" maxlength="50" value="Auto" readonly required>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input allow-empty="false" type="text" placeholder="Necklaces Title" name="NecklacesName" id="NecklacesName" class="form-control" maxlength="50" value="" required>
                        </div>

                         <div class="form-group col-md-6">
                            <label>Necklaces Description</label>
                            <textarea id="NecklacesDescription" name="NecklacesDescription" rows="10" cols="30" class="form-control" placeholder="Banner Description" required></textarea>
                        </div>
...
<script>
  ...
  function delete_data(){
      id=$("#target").val();
      $.post("<?php echo base_url('index.php/c_necklaces/gf_delete'); ?>",
      {
        id_data:id
      },
  ...
  function edit(id,name,desc){
      ...
      $('#canceledit').show();
      $("#NecklacesId").val(id);
      $("#NecklacesName").val(name);
      $("#NecklacesDesc").val(desc);
      
      $.post("<?php echo base_url('index.php/c_necklaces/gf_tag_database'); ?>",
      {
        id_data:id
      },
